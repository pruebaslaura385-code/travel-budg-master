    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Sistema de Presupuestos de Viaje</CardTitle>
          <CardDescription>
            Gestiona presupuestos de viaje para tu empresa
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            <AlertDescription className="text-center">
              Acceso exclusivo para personal autorizado con dominio <strong>@miempresa.com</strong>
            </AlertDescription>
          </Alert>
